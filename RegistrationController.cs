...
namespace student_management.Controllers
{
    public class RegistrationController : Controller
    {
        ...
        {
            var registrations = db.registrations.Include(r => r.branch).Include(r => r.course);
        ...
        {
            ViewBag.batch_id = new SelectList(db.branches, "id", "batch");
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id,telno")] registration registration)
        {
            ...
            ViewBag.batch_id = new SelectList(db.branches, "id", "batch", registration.batch_id);
